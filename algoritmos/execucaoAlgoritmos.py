...
estadoAtualBL, custoCaminhoBL, custoEspacoBL, custoTempoBL, profundidadeSolBL, profundidadeMaxBL, _ = buscaEmLarguraMain(entrada, estadoFinal)
estadoAtualBP, custoCaminhoBP, custoEspacoBP, custoTempoBP, profundidadeSolBP, profundidadeMaxBP, _ = buscaEmProfundidadeMain(entrada, estadoFinal)
estadoAtualBG, custoCaminhoBG, custoEspacoBG, custoTempoBG, profundidadeSolBG, profundidadeMaxBG, _ = buscaGulosa(entrada, estadoFinal)
estadoAtualBA, custoCaminhoBA, custoEspacoBA, custoTempoBA, profundidadeSolBA, profundidadeMaxBA, _ = buscaAEstrela(entrada, estadoFinal)
